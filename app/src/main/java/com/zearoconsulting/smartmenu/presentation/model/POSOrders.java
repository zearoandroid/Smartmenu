...
public class POSOrders implements Serializable {
    ...
    public void setIsCashCustomer(int isCashCustomer) { this.isCashCustomer = isCashCustomer; }
    ...
    public String getIsDiscounted() { return isDiscounted; }

    public void setIsDiscounted(String isDiscounted) { this.isDiscounted = isDiscounted; }
